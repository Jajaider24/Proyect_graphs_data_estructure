...
class PlanningSession:
    ...
    def _consume_minutes(self, minutes: float) -> float:
    ...
    def _apply_job_decision(self, decision: Dict[str, Any]) -> Dict[str, Any]:
        if self.transit is not None:
    ...
    def _apply_activities_decision(self, decision: Dict[str, Any]) -> Dict[str, Any]:
        if self.transit is not None:
    ...
    def _apply_stay_decision(self, decision: Dict[str, Any]) -> Dict[str, Any]:
        if self.transit is not None:
    ...
    def _apply_flight_decision(self, decision: Dict[str, Any]) -> Dict[str, Any]:
        if self.transit is not None:
    ...
    def _apply_advance_decision(self, decision: Dict[str, Any]) -> Dict[str, Any]:
