...
def maximize_destinations(
    ...
    start_airport = graph.get_airport(
        start_airport_id
    )

    traveler = Traveler(
        current_airport=start_airport,
        initial_budget=constraints.max_budget,
        available_time=constraints.max_time
    )

    traveler.visit_airport(
        start_airport
    )
    ...
    def dfs(current_airport, traveler_state):
        ...
        current_total = len(
            traveler_state.visited_airports
        )
        ...
        for route in current_airport.routes:
            ...
            if (
                constraints.avoid_hubs
                and destination.es_hub
            ):
                continue
